...
sudo consul agent -ui=false -bind=192.168.100.2 -client=0.0.0.0 -data-dir=. -node=cliente -retry-join="192.168.100.3" -retry-join="192.168.100.2" -retry-join="192.168.100.8" &


#sudo consul agent -ui -server -bind=192.168.100.2 -client=0.0.0.0 -data-dir=/opt/consul -node=nodo2 -bootstrap-expect=2 -retry-join="192.168.100.3" -retry-join="192.168.100.2"
